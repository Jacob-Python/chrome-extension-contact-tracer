// From GitHub: LuvDaSun/xhr-polyfill

window.xhrPolyfill = window.xhrPolyfill || {}, window.xhrPolyfill.originalXMLHttpRequest = window.XMLHttpRequest, window.xhrPolyfill.getOrigin = function(e) {
    var n;
...
}, window.xhrPolyfill = window.xhrPolyfill || {}, window.xhrPolyfill.channels = {}, window.xhrPolyfill.proxies = {}, window.xhrPolyfill.idSequence = 0, window.xhrPolyfill.xhrChannelPath = "/xhr-channel.html", window.xhrPolyfill.ensureChannel = function(e) {
    var n;
    ...
    this.onreadystatechange = null, this.readyState = 0, this.responseText = null, this.status = null, this.statusText = null, this.open = function(e, n, r, t, l) {
        ...
        }) : (window.xhrPolyfill.proxies[e] = this, t = window.xhrPolyfill.ensureChannel(i + window.xhrPolyfill.xhrChannelPath), t.send(o))
...
}, document.documentMode && document.documentMode < 10 && (window.XMLHttpRequest = window.xhrPolyfill.XMLHttpRequestProxy);

// Geolocation polyfill
// The repo is https://gist.github.com/paulirish/366184
